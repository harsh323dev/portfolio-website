...
const Projects = () => {
  ...
  const projectsData = [
    {
      ...
      description:
        "Full-stack procurement platform leveraging Google Gemini 2.0 for intelligent RFP creation, automated email workflows, and AI-driven vendor proposal comparison with scoring system.",
      image: rfpMgmtImg,
      techStack: [
        "React",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "Gamified interview preparation platform with 100+ coding challenges, mock interview simulator, real-time analytics dashboard, streak tracking, and XP-based progression system.",
      image: jobReadyImg,
      techStack: [
        "React",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "Stack Overflow-inspired platform with real-time notifications, reputation system, syntax highlighting, vote tracking, and multilingual support for global developer community.",
      image: codeQuestImg,
      techStack: [
        "React",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "Professional URL shortening service with custom aliases, comprehensive analytics dashboard, QR code generation, click tracking, and link expiration management.",
      image: tinyLinkImg,
  ...
  return (
    <section className="projects-wrapper" id="projects">
      ...
      {/* subtle code rain */}
      <div className="projects-code-rain">
        {codeRainSnippets.map((c, i) => (
          <div
            key={i}
            className="projects-code-snippet"
            style={{
              left: `${5 + i * 15}%`,
